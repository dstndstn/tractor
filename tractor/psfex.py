    ...
    def plot_grid(self, xx, yy, term=None, stampsize=None, **kwargs):
        ...
        for y in yy:
            for x in xx:
                ...
                plt.yticks([])
        if term is not None:
            plt.suptitle('PSF component for x^%i y^%i' %
                         (xpows[term], ypows[term]))
...
if __name__ == '__main__':
    ...
    psf = PixelizedPsfEx(
        'decals/calib/decam/psfex/00176/00176798/decam-00176798-N1.fits')
    ...
    psf = PsfEx(
        'cs82data/ptf/PTF_201112091448_i_p_scie_t032828_u010430936_f02_p002794_c08.fix.psf', 2048, 4096)
