import numpy as np
#import tractor.mixture_profiles as mp
from tractor import mp_fourier
import time

amps = np.array([  1.99485977e-04,   2.61612679e-03,   1.89726655e-02,
                  1.00186544e-01,   3.68534484e-01,   5.09490694e-01])
means = np.array([[-22.41149365, -24.20769429],
                  [-22.41149365, -24.20769429],
                  [-22.41149365, -24.20769429],
                  [-22.41149365, -24.20769429],
                  [-22.41149365, -24.20769429],
                  [-22.41149365, -24.20769429]])
vars = np.array([[[  3.53418182e-03,   8.54829918e-08],
...
v = np.array([ 0.      ,  0.015625,  0.03125 ,  0.046875,  0.0625  ,  0.078125,
...
w = np.array([ 0.      ,  0.015625,  0.03125 ,  0.046875,  0.0625  ,  0.078125,
               0.09375 ,  0.109375,  0.125   ,  0.140625,  0.15625 ,  0.171875,
               0.1875  ,  0.203125,  0.21875 ,  0.234375,  0.25    ,  0.265625,
               0.28125 ,  0.296875,  0.3125  ,  0.328125,  0.34375 ,  0.359375,
               0.375   ,  0.390625,  0.40625 ,  0.421875,  0.4375  ,  0.453125,
